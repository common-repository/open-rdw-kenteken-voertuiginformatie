            ...
            <header class="panel-heading">
                <div class="row">
                    <div class="column column-80">
                        <h2 class="intro">Welkom bij de OpenRDW PRO plugin</h2>
                        <p class="intro">Bedankt voor het installeren van de OpenRDW WordPress plugin.</p>
                        <p class="intro">We wensen je veel plezier met het gebruik van de plugin.</p>
                    </div>
                    <div class="column column-20" id="version-badge">
                        <span>Versie: <?php echo ORK_VERSION; ?></span>
                    </div>
                </div>
            ...
            <div id="getting-started">
                <div class="row">
                    <div class="blue-notice">
                        <p>Welkom bij de volledig vernieuwde versie van de <strong>Open RDW PRO</strong> plugin. Bekijk hier wat er allemaal nieuw is of bekijk de voordelen van de volledig nieuwe OpenRDW PRO variant. <strong>Let op:</strong> Controleer ook de instellingen in het vernieuwde dashboard om er zeker van de zijn dat de plugin blijft functioneren.</p>
                    </div>
                </div>
                <div class="row">
                    ...
                    <img class="column column-50" src="<?php echo ORK_PLUGIN_PATH; ?>/public/images/stap1-installation.png">
                </div>
                <div class="row">
                    <img class="column column-50" src="<?php echo ORK_PLUGIN_PATH; ?>/public/images/stap2-kenteken-invoer.png">
                ...
                <div class="row">
                    ...
                    <img class="column column-50" src="<?php echo ORK_PLUGIN_PATH; ?>/public/images/stap3-formulieren.png">
                </div>
                <div class="row">
                    <img class="column column-50" src="<?php echo ORK_PLUGIN_PATH; ?>/public/images/stap3-formulieren.png">
                    <div class="column column-50">
                        <h3>Stap 4: Customize met uitbreidingen</h3>
                        <p>Sinds versie 2.1.0 biedt deze plugin de mogelijkheid om extensies te installeren. Zo zijn er standaard integraties met WooCommerce, maar ook kentekenkoppelingen voor het toevoegen van posts binnen WordPress of het direct plaatsen van aangemelde voertuigen. We kunnen ook op verzoek uitbreidingen schrijven voor onze OpenRDW plugin.</p>
            ...
            <div id="whats-new" style="display: none;">
                ...
                <div class="row">
                    <div class="column column-50 end">
                        <h3>Versie 2.2.3 <code>27-10-2020</code></h3>

                        <ul>
                            <li>
                                <code>Updated:</code>
                                Missing CF7 field validation
                            </li>
                            <li>
                                <code>Updated:</code>
                                Removed deprecated jQuery function
                            </li>
                        </ul>
                    </div>
                    <div class="column column-50 end">
                        <h3>Versie 2.2.2 <code>09-03-2020</code></h3>
                ...
                <div class="row">
                    <div class="column column-50 end">
                        <h3>Versie 2.2.1 <code>27-02-2020</code></h3>

                        <ul>
                            <li>
                                <code>Fixed:</code>
                                An issue with QuForm
                            </li>
                            <li>
                                <code>Added:</code>
                                Filters before and after getting data from the API.
                            </li>
                        </ul>
                    </div>
                    <div class="column column-50 end">
                        <h3>Versie 2.2.0 <code>27-02-2019</code></h3>

                        <ul>
                            <li>
                                <code>Added:</code>
                                Output formatters to change the default display of fields in a certain way
                            </li>
                            <li>
                                <code>Added:</code>
                                Default output formatters for dates
                            </li>
                            <li>
                                <code>Added:</code>
                                Default output formatters for money
                            </li>
                            <li>
                                <code>Added:</code>
                                Default output formatters for strings
                            </li>
                            <li>
                                <code>Added:</code>
                                Default output formatters for developers (timestamps and callbacks)
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="column column-50 end">
                        <h3>Versie 2.1.6 <code>30-10-2018</code></h3>

                        <ul>
                            <li><code>Fixed:</code> An issue with WooCommerce compatability</li>
                        </ul>
                    </div>
                    <div class="column column-50 end">
                        <h3>Versie 2.1.5 <code>21-03-2018</code></h3>
                ...
                <div class="row">
                    <div class="column column-50 end">
                        <h3>Versie 2.1.4 <code>14-11-2017</code></h3>

                        <ul>
                            <li><code>Added:</code> Tabindex attribute for the Gravity Forms fields.</li>
                            <li><code>Fixed:</code> The fields select for Gravity Forms is now sorted alphabetically.</li>
                        </ul>
                    </div>

                    <div class="column column-50 end">
                        <h3>Versie 2.1.3 <code>18-06-2017</code></h3>

                        <ul>
                            <li><code>Fixed:</code> A bug that affected the plugin installation screen</li>
                        </ul>
                    </div>
                </div>
                <div class="row">
                    <div class="column column-50 end">
                        <h3>Versie 2.1.2 <code>19-12-2016</code></h3>

                        <ul>
                            <li><code>Fixed:</code> Replaced deprecated function (Contact Form 7)</li>
                            <li><code>Fixed:</code> Small bugs</li>
                        </ul>
                    </div>
                    <div class="column column-50 end">
                        <h3>Versie 2.1.1<code>11-11-2016</code></h3>
                        <ul>
                            <li><code>Improved:</code> We've updated some internal components making this the fastest version yet! :D</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="column column-50 end">
                        <h3>Versie 2.1.0 <code>08-07-2016</code></h3>

                        <ul>
                            <li><code>Added:</code> Logging capabilities for debugging</li>
                            <li><code>Added:</code> Extensions. This offers the possibility to extend this plugin.</li>
                        </ul>
                    </div>

                    <div class="column column-50 end">
                        <h3>Versie 2.0.3 <code>23-06-2016</code></h3>

                        <ul>
                            <li><code>Fixed:</code> Plugin Update Checker</li>
                        </ul>
                    </div>
                </div>
                <div class="row">
                    <div class="column column-50 end">
                        <h3>Versie 2.0.2 <code>20-06-2016</code></h3>

                        <ul>
                            <li><code>Added:</code> Gravity Forms support</li>
                        </ul>
                    </div>
                    <div class="column column-50 end">
                        <h3>Versie 2.0.1 <code>09-05-2016</code></h3>
                        <ul>
                            <li><code>Fixed:</code> Squashed some bugs!</li>
                            <li><code>Improved:</code> Stability</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="column column-50 end">
                        ...
                        <ul>
                            ...
                            <li><code>Improved:</code> Switched API calls from XML to JSON, significantly improving the loading speed.</li>
                            <li><code>Improved:</code> Usability with Contact Form 7</li>
                            <li><code>Added:</code> Introduction screen to the plugin</li>
                            <li><code>Added:</code> Easy settings management</li>
                            <li><code>Added:</code> Easier management of shortcode's</li>
                            <li><code>Added:</code> Easier placement of widget</li>
                            <li><code>Added:</code> Multiple selection of fields</li>
                            <li><code>Added:</code> Order information fields within the widget/shortcode or CF7</li>
                            <li><code>Added:</code> Support for over 80 values per license plate</li>
                        </ul>
                    </div>
                    <div class="column column-50 end">
            ...
            <div id="go-pro" style="display: none;">
                <div class="row">
                    ...
                    <ul>
                        ...
                        <li>QuForm en iPhorm ondersteuning (Gravityforms komt er aan)</li>
                    </ul>
                    <br/>
                    <p>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery('#toplevel_page_open_data_rdw').append('<div id="install-popup">Hier vindt je de instellingen van de Open RDW Pro plugin! <span>&times;</span></div>');
